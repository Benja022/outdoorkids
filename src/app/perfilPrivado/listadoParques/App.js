...
const App = () => {
    ...
    const handleImageChange = (direction) => {
        if (!selectedPlace || !selectedPlace.photos || selectedPlace.photos.length < 2) return;
        ...
        <div className={styles.App}>
            ...
            <div className={styles.searchWrapper}>
                ...
                <div className={styles.filterContainer}>
                    <label htmlFor="activityType" className={styles.filterLabel}>Selecciona tipo de actividad:</label>
                    <select
                        id="activityType"
                        value={activityType}
